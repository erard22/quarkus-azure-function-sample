...
```
curl "https://nubesgen.com/quarkus-azure-functions-sample.tgz?iactool=TERRAFORM&region=westeurope&application=FUNCTION.consumption&runtime=DOCKER&database=SQL_SERVER.serverless" | tar -xzvf -
```
